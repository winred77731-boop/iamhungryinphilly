...
export default function Team() {
  ...
  const members = [
    ...
    { name: "Harry G. Hayman IV", role: "Producer", img: "/images/producer-hayman-v2.png", portraitClass: "team-portrait--harry", bio: "A longtime Philadelphia hospitality entrepreneur and food-policy advocate, Harry has spent years working at the intersection of food, hunger, hospitality and economic development. I Am Hungry in Philadelphia grew out of his work alongside organizations and individuals confronting food insecurity across the city—and his belief that changing the system begins with changing how people understand the problem." },
  ];
